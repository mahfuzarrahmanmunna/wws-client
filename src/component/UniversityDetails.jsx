...
import banner from "../assets/Banner22.jpg" // Default banner image
import ContactHome from './ContactHome';

/**
 * Reusable University Detail Banner Component
 * 
 * @param {Object} props - Component props
 * @param {string} props.universityName - Name of the university
 * @param {string} props.destination - Country where university is located
 * @param {number} props.established - Year university was established
 * @param {number} props.ranking - Global ranking of the university
 * @param {string} props.description - University description
 * @param {Array<string>} props.coursesOffered - List of courses offered
 ...
 * @param {string} props.campusLocation - Campus location details
 ...
 *   established={1826}
 *   ranking={8}
 *   description="UCL is a top global university..."
 *   coursesOffered={["Law", "Architecture", "Computer Science"]}
 *   tuitionFee="£18,000 - £38,000 per year"
 ...
 *   campusLocation="London, UK"
 *   bannerImage={uclBannerImage}
 * />
 */
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative w-full h-[500px] sm:h-[600px] lg:h-[700px] overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img 
            src={banner}
            alt={`${universityName} in ${destination}`} 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="max-w-2xl">
              ...
              <nav className="text-sm sm:text-base mb-4">
                ...
                <span className="mx-2 text-black">/</span>
                <span className="font-medium text-black">{universityName}</span>
              </nav>
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 leading-relaxed mb-8 max-w-xl">
                Established {established} • Ranked #{ranking} Globally • {campusLocation}
              </p>
      ...
      <div className="bg-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Description */}
          <div className="mb-12">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">About {universityName}</h3>
          ...
          {/* Courses Offered */}
          <div className="mb-12">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Popular Courses</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-800 text-lg">{campusLocation}</p>
            </div>
            ...
            {/* Ranking */}
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Global Ranking</h3>
              <p className="text-gray-800 text-lg">#{ranking} in the World</p>
            </div>
          </div>
