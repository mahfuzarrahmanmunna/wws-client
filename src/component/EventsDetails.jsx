...
import banner from "../assets/bn.jpg" // Default banner image
import ContactHome from './ContactHome';

/**
 * Reusable Event Detail Banner Component
 * 
 * @param {Object} props - Component props
 * @param {string} props.city - City where event is held
 * @param {string} props.month - Month of the event
 * @param {string} props.destination - Country/destination of the event
 * @param {string} props.programType - Type of program (Undergraduate & Graduate/etc)
 * @param {string} props.duration - Duration of the program
 * @param {string} props.description - Event description
 * @param {string} props.deadline - Application deadline
 * @param {string} props.eligibility - Eligibility criteria
 * @param {string} props.benefits - Benefits of the event
 * @param {string} props.applicationLink - URL for application
 * @param {string} props.organizer - Event organizer
 ...
 *   duration="4 years (undergraduate), 2 years (graduate)"
 *   description="This extensive scholarship initiative..."
 *   deadline="2025-10-30"
 *   eligibility="Bangladeshi students with GPA 3.2+..."
 *   benefits="Full tuition, living stipend..."
 *   applicationLink="https://example.com/apply/usa-november"
 *   organizer="US Education Board"
 *   contactEmail="scholarships@usboard.org"
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative w-full h-[500px] sm:h-[600px] lg:h-[700px] overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img 
            src={banner}
            alt={`${programType} in ${destination}`} 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="max-w-2xl">
              ...
              <nav className="text-sm sm:text-base mb-4">
                <span className="opacity-80 text-black">Events</span>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-800 text-lg">{formattedDeadline}</p>
            </div>
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              <div className="flex items-start">
                ...
                <p className="text-blue-800 text-lg">
                  This event will take place in {city} during {month.charAt(0).toUpperCase() + month.slice(1)}. 
                  All applications must be submitted by {formattedDeadline}. 
